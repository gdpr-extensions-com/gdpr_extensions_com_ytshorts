...
{
    /**
     * @var \GdprExtensionsCom\GdprExtensionsComYtshorts\Domain\Model\GdprManager|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \GdprExtensionsCom\GdprExtensionsComYtshorts\Domain\Model\GdprManager::class,
            ['dummy']
        );
    }
